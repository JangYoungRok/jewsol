...
<head>
	...
	<link rel="stylesheet" href="/jewsol/css/factory/release/insertRelease.css">
	<title>출고 입력</title>
</head>
<body>
	...
	<script type="text/javascript" src="/jewsol/javascript/factory/release/insertRelease.js"></script>
	<nav id="gnb">
	...
	<section id="mainPanel">
		<article id="triggerPanel">
			<jsp:include page="${branchListJsp }" />
			<input type="button" id="insertReleaseBtn" value="출고 입력">
		</article>
