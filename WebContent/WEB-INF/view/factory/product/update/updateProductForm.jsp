	...
	<section id="mainPanel">
		<form name="updateProductForm" enctype="multipart/form-data" method="POST" action="/jewsol/factory/product/update/updateProduct.do">
			...
			<article id="productPanel">
				...
				<p>
					<br>
					제품 이름&nbsp;&nbsp; &nbsp;:&nbsp;&nbsp; &nbsp;<input type="text" id="productName" value="" disabled="disabled"><br>
					<br>
					제품 평균 중량&nbsp;:&nbsp;<input type="text" name="productAveWeight" id="productAveWeight" value="" readonly>
				</p>
			</article>
			
			<article id="triggerPanel">
				<input type="button" id="updateProduct" value="제품 수정" disabled><br>
				<input type="button" id="notInUseProduct" value="제품 이용 중지" disabled><br>
				<input type="radio" name="getProductOption" value="O" disabled>제품상세수정
				<input type="radio" name="getProductOption" value="X" checked disabled>제품상세보기
			</article>
