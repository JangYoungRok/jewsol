	...
	<c:forEach var="i" begin="1" end="9">
		<c:if test="${i <= fn:length(optionCzList)}">
			<p>
				...
				<input type="text" name="czQty" size="4" maxlength="4" value ="${optionCzList[i-1].optionCzQty }" readonly>
				<select name="cz">
	...
	<c:forEach var="i" begin="1" end="9">
		<c:if test="${i <= fn:length(optionStoneList)}">
			<p>
				...
				<input type="text" name="stoneQty" size="4" maxlength="4" value ="${optionStoneList[i-1].optionStoneQty }" readonly>
				<select name="stone">
