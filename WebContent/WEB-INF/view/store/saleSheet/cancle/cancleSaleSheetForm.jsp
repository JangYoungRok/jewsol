...
<head>
	...
	<link rel="stylesheet" href="/jewsol/css/store/saleSheet/cancleSaleSheet.css">
	<title>판매 취소</title>
</head>
<body>
	...
	<script type="text/javascript" src="/jewsol/javascript/store/saleSheet/cancleSaleSheet.js"></script>
	<script type="text/javascript" src="/jewsol/javascript/store/saleSheet/customerListInterfaceForCancleSaleSheet.js"></script>
	<nav id="gnb">
	...
	<section id="mainPanel">
		...
		<article id="column">
			<section id="triggerPanel">
				<div>
					<input type="text" id="customer"> <input type="button" id="searchCustomerBtn" value="거래처 검색"><br>
					<input type="button" id="cancleSaleSheetBtn" value="판매 취소">
				</div>
